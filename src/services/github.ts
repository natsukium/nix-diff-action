...
${artifactHint}
  ...
  const footer = `---
<sub>Generated by a [fork](https://github.com/oake/nix-diff-action) of [nix-diff-action](https://github.com/natsukium/nix-diff-action) using [dix](https://github.com/faukah/dix)</sub>
